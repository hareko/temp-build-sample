...
(function (root, factory) {
  ...
  return function (opts) {
    ...
    var Init = function (opt) {
      ...
      updn = typeof opt.updn === 'undefined' ? true : opt.updn; //update sequence manner
      that.error = {};

      /* detect NodeJS environment */
      if (typeof process !== 'undefined' && process.versions && process.versions.node) {
        var p = typeof opt.path === 'string' ? opt.path : '';
      ...
      mde = Mode(); //check functionality
      that.Init();
    };

    /**
     * check functionality, determine mode
